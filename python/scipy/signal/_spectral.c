...
static char __pyx_k_home_rgommers_Code_scipy_scipy[] = "/home/rgommers/Code/scipy/scipy/signal/_spectral.pyx";
 ...
 *             ((c_tau * xs - s_tau * xc)**2 / \
 */
    __pyx_t_6 = PyFloat_FromDouble((0.5 * ((__pyx_t_17 / __pyx_t_21) + (__pyx_t_22 / __pyx_t_23)))); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 166; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
